...
function normalizeEvent(e) {
  return {
    ...
    pageGroup:        typeof e.pageGroup === 'string' ? e.pageGroup.slice(0, 100) : null,
    zone:             typeof e.zone === 'string' ? e.zone.slice(0, 100) : null,
